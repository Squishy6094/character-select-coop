...
if _G.charSelectExists then
    _G.charSelect.character_add("Callie", {"The loud and sweet Callie from", "Inkopolis' Squid Sisters!"}, "frijoles.z64", {r = 255, g = 31, b = 137}, E_MODEL_CALLIE, CT_MARIO, TEX_CALLIE)
    _G.charSelect.character_add("Marie", {"The smart and quiet Marie from", "Inkopolis' Squid Sisters!"}, "frijoles.z64", {r = 0, g = 209, b = 138}, E_MODEL_MARIE, CT_LUIGI, TEX_MARIE)
